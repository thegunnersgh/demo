      ...
      <div class="row">
       <!-- Left Image-->
          ...
          <ul class="thumbnails mainimage">
            <li class="span5">
              <a  rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4" class="thumbnail cloud-zoom" href="img/product1big.jpg">
                <img src="{!! asset('resources/upload/'.$products->image) !!}" alt="" title="">
              </a>
            </li>
            <li class="span5">
        ...
        <div class="span7">
          <div class="row">
            <div class="span7">
              <h1 class="productname"><span class="bgnone">{!! $products->name !!}</span></h1>
              <div class="productprice">
                <div class="productpageprice">
                  <span class="spiral"></span>{!! number_format($products->price, 0, ',', '.') !!}</div>
              </div>
              <ul class="productpagecart">
                <li><a class="cart" href="{!! url('mua-hang',[$products->id, $products->alias]) !!}">Add to Cart</a>
                </li>
              </ul>
  ...
  <section id="related" class="row">
    <div class="container">
      ...
      <ul class="thumbnails">
        ...
        @foreach($pro_cungloai as $cungsp)
        <li class="span3">
          <a class="prdocutname" href="product.html">{!! $cungsp->name !!}</a>
          <div class="thumbnail">
            <span class="offer tooltip-test" >Offer</span>
            <a href="{!! url('chi-tiet-san-pham', [$cungsp->id, $cungsp->alias]) !!}"><img alt="" src="{!! asset('resources/upload/'.$cungsp->image) !!}"></a>
            <div class="pricetag">
              <span class="spiral"></span><a href="#" class="productcart">ADD TO CART</a>
              <div class="price">
                <div class="pricenew">{!! number_format($cungsp->price, 0, ',', '.') !!}</div>
