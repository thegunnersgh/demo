<footer id="footer">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="span3 contact">
          <h2>Contact Us </h2>
          <ul>
            <li class="phone"> 01649 520 893</li>
            <li class="mobile"> 03213 666 888</li>
            <li class="email"> nhanarsenal0906@gmail.com</li>
            <li class="email"> tuanarsenal0906@gmail.com</li>
          </ul>
        </div>
  ...
  <section class="footerlinks">
    <div class="container">
      ...
      <div id="footersocial">
        <a href="https://www.facebook.com/nhan.nguyenvan.7106" title="Facebook" class="facebook">Facebook</a>
  ...
  <section class="copyrightbottom">
    <div class="container">
      <div class="row">
        ...
        <div class="span6 textright"> ShopSimple @ 2015 </div>
      </div>
    </div>
  </section>
